...
public class LeakDialogFragment extends Fragment
    ...
    private DialogInterface.OnCancelListener mOnCancelListener =
            new WeakDialogCancelListener(this);

    private DialogInterface.OnDismissListener mOnDismissListener =
            new WeakDialogDismissListener(this);
    ...
    static class WeakDialogDismissListener implements DialogInterface.OnDismissListener {

        private WeakReference<LeakDialogFragment> leakDialogFragmentWeakReference;

        public WeakDialogDismissListener(LeakDialogFragment leakDialogFragment) {
    ...
    static class WeakDialogCancelListener implements DialogInterface.OnCancelListener {

        private WeakReference<LeakDialogFragment> leakDialogFragmentWeakReference;

        public WeakDialogCancelListener(LeakDialogFragment leakDialogFragment) {
            this.leakDialogFragmentWeakReference = new WeakReference<>(leakDialogFragment);
        }
